...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(!FlxG.save.data.brutalUnlocked)
		{
		...
		for (i in 0...blockedShit.length)
		{
			...
			{
				PlayState.obsOpen = true;
			}
		}

		FlxG.save.data.illegitamite = true;
		...
		if(FlxG.save.data.achievements == null)
			FlxG.save.data.achievements = [false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false];
	}
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			new FlxTimer().start(2, function(tmr:FlxTimer)
			{
				...
				http.onData = function (data:String) {
				  	...
				  	if (!HardModeIsActuallyFuckingHardState.leftState)
					{
						FlxG.switchState(new HardModeIsActuallyFuckingHardState());
					}
					else
					{
						#if desktop
