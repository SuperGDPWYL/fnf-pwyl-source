...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, "Playing With Your Life " + corruptVer + corruptDev , 12);
	...
	function giveAchievement() {
		add(new AchievementObject(achievementID, FlxG.camera));
					...
					menuItems.forEach(function(spr:FlxSprite)
					{
						...
						else
						{
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								/*if(!gameSave.data.unlockedAnarchist)
								{
									gameSave.bind("unlockedAnarchist");
									gameSave.data.unlockedAnarchist = false;
									gameSave.flush();
								}*/
								...
								switch (daChoice)
								{
									...
									case 'awards':
										...
										trace("Achievement Menu Selected");
