...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCatagory> = [
		new OptionCatagory("PWYL", [
		//	new NoModcharts("If you're prone to motion sickness I'd suggest turning these off."),
			new DiscordServer("Join the official PWYL server! (WARNING: OPENS A URL, DO NOT USE IF THIS KILLS YOUR PC)")
		]),
		new OptionCatagory("Gameplay", [
			new DFJKOption(controls),
			new Immortality("Not skilled enough to beat the song? Turn this on to disable death."),
			new OffsetMenu("Get a note offset based off of your inputs!"),
			new CustomizeGameplay("Drag'n'Drop Gameplay Modules around to your preference"),
		//	new SpikesOption("Toggle spikes! (Turning off spikes will stamp a big notice on your game)"),
			new Corrupted("Allow corrupted sessions"),
			new VanillaInputs("Troll your friends with these nightmarish inputs!"),
			new CutsceneOption("Make cutscenes appear in Freeplay!")
		]),
		new OptionCatagory("Appearence", [
			new SkinSelection("Press to enter the Skin Selector."),
