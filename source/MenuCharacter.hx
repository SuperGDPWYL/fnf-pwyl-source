...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'corrupt' => new CharacterSetting(-15, 130)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		frames = Paths.getSparrowAtlas('campaign_menu_UI_characters_idk');
		...
		animation.addByPrefix('corrupt', "Corrupt Idle BLACK LINES", 24);
